...
@Component({
  ...
  template: `
  <div nz-dropdown class="alain-default__nav-item" nzTrigger="click" 
       nzPlacement="bottomRight" (nzVisibleChange)="change()" [nzDropdownMenu]="menuTpl">
    <nz-badge [nzDot]="true">
      <i nz-icon type="bell" class="alain-default__nav-item-icon"></i>
    </nz-badge>
  </div>
  <nz-dropdown-menu class="wd-lg" #menuTpl="nzDropdownMenu">
